 ...
 *         &lt;element name="listaSuscripcion" type="{http://comercio.com.pe/eai/services/GestionSuscripcionWS/ws/types}ListaSuscripcionesType"/>
...
@XmlRootElement(name = "listarSuscripcionResponse")
public class ListarSuscripcionResponse {

    @XmlElement(required = true)
    protected ParametrosAuditResponse auditResponse;
    @XmlElement(required = true)
    protected ListaSuscripcionesType listaSuscripcion;
    @XmlElement(required = true)
    ...
    /**
     * Obtiene el valor de la propiedad listaSuscripcion.
     * 
     * @return
     *     possible object is
     *     {@link ListaSuscripcionesType }
     *     
     */
    public ListaSuscripcionesType getListaSuscripcion() {
        return listaSuscripcion;
    }

    /**
     * Define el valor de la propiedad listaSuscripcion.
     * 
     * @param value
     *     allowed object is
     *     {@link ListaSuscripcionesType }
     *     
     */
    public void setListaSuscripcion(ListaSuscripcionesType value) {
        this.listaSuscripcion = value;
    }
